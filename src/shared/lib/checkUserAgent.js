import { getOs } from './getOsName';
import { getBrowser } from './getBrowserName';
import { changeBrowser } from './changeBrowser';
import { getIsMobile } from './getIsMobile';

export const checkUserAgent = (useChange) => {
  ...
  if (browserName !== 'chrome') {
    alert(
      '본 서비스는 Chrome을 권장합니다. 브라우저 팝업이 나타나면 Chrome을 선택해주세요.',
    );
